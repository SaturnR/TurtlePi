...
PORT = 42001
HOST = "192.168.1.155" #askstring('Scratch Connector', 'IP:')
#if not HOST:
#    sys.exit()
...
#        print(com)
        ...
        if(com=='back'):
            ...
            if(xy): 
                print(xy) #------------------------
                sendScratchCommand('sensor-update "QRx" '+str(xy.x))
                sendScratchCommand('sensor-update "QRy" '+str(xy.y))
        elif(com=='getfacexy'):
            xy=fc.getXY()
            if(xy): 
                print(xy)
